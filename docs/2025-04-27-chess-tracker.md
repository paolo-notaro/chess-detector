...
You can see the diagram above for a simplified version of the [SiameseNet](https://github.com/paolo-notaro/chess-detector/blob/main/src/chess_detector/models/pair.py) pipeline.
